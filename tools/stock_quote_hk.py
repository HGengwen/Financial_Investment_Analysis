...
使用 akshare 库获取港股历史K线数据，支持东方财富数据源。
...
Usage:
    {py} tools/stock_quote_hk.py --code 00700
    {py} tools/stock_quote_hk.py --code 00700 --start 20260101 --end 20260710
    {py} tools/stock_quote_hk.py --code 00700 --adjust qfq
    {py} tools/stock_quote_hk.py --index HSI
"""
