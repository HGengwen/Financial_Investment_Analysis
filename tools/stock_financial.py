...
Usage:
    {py} tools/stock_financial.py --code 300502
    {py} tools/stock_financial.py --code 300502 --indicator all
    {py} tools/stock_financial.py --code 300502 --indicator ROE
    {py} tools/stock_financial.py --code 300502 --indicator 毛利率,净利率
"""
