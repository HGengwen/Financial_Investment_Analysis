...
- `.trae/skills/` — 投研技能文件（30 个 SKILL.md + README.md，另有 `tools-scripts/` 工具使用参考文档）
...
技能安装在 `.trae/skills/` 目录下，共 **30 个技能**，覆盖行业研究、公司深度研究、买入决策、中期投研（1-3年）、收入投资、财报跟踪、持仓管理、基础工具与内容输出八大类（另有 `tools-scripts/` 存放工具使用参考文档）。
...
| `/wechat-article {主题}`    | 微信公众号文章：作者-编辑-读者三 Agent 协作产出可发布文章     |
